...
- [](#)
  - [🛠️ 6.1. Quick Start in 3 Steps](#️-61-quick-start-in-3-steps-1)
...
3. **Open the Dashboard:** Once the startup logs stabilize, open your preferred browser and navigate to the local portal to begin managing your viticulture mapping, alerts, and vision diagnostics:<a href="http://localhost:4321">
      🔗 Open EdgeVine Dashboard 🍇 (http://localhost:4321)
  </a>
